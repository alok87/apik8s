...
import (
	...
	. "github.com/alok87/apik8s/pkg/client/clientset_generated/clientset/typed/authentication/v1"
...
var _ = Describe("Token controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "token-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.AuthenticationV1().Tokens("token-controller-test-handler")
