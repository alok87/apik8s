...
import (
	...
	. "github.com/alok87/apik8s/pkg/client/clientset_generated/clientset/typed/authentication/v1alpha1"
...
var _ = Describe("TokenReview controller", func() {
	var instance TokenReview
	...
	BeforeEach(func() {
		instance = TokenReview{}
		instance.Name = "instance-1"
		expectedKey = "tokenreview-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.AuthenticationV1alpha1().TokenReviews("tokenreview-controller-test-handler")
