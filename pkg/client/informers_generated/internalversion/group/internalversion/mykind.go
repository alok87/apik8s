...
import (
	...
	internalversion "github.com/alok87/apik8s/pkg/client/listers_generated/group/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.Group().Mykinds(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.Group().Mykinds(namespace).Watch(options)
			},
		},
		&group.Mykind{},
		resyncPeriod,
...
func defaultMykindInformer(client internalclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewMykindInformer(client, v1.NamespaceAll, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
}

func (f *mykindInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&group.Mykind{}, defaultMykindInformer)
}
