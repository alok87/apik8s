...
import (
	...
	"github.com/alok87/apik8s/pkg/client/clientset_generated/clientset/scheme"
...
// AuthenticationV1Client is used to interact with features provided by the authentication.practodev.com group.
type AuthenticationV1Client struct {
	restClient rest.Interface
}

func (c *AuthenticationV1Client) Tokens(namespace string) TokenInterface {
